...
## AndroVNC- VNC in your browser

AndroVNC is based on [noVNC](https://github.com/novnc/noVNC). It is a noVNC is both a HTML VNC client JavaScript library and an application built on top of that library. Andronix uses AndroVNC to connect without using a dedicated VNC client on the device, that ensure performance and saves space on the client device.
